...
@section('title', "Halaman Detail Materi")
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ID Materi : {{ $materi->id }} <br>
                            Nama : {{ $materi->nama }} <br>
                            Deskripsi : {{ $materi->deskripsi }} <br>
                            Tanggal Buat : {{ $materi->created_at }} <br>
                            Tanggal Update : {{ $materi->updated_at }} <br>
                        </div>
                        <!-- /.card-body -->
